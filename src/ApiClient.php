        ...
        $data = [
            ...
            'attributes' => [
                ...
                'customer' => [
                    ...
                    'deliveryTimeOnMondayFrom' => $orderRequest->getCustomer()->getDeliveryTimeOnMondayFrom(),
                    'deliveryTimeOnMondayTo' => $orderRequest->getCustomer()->getDeliveryTimeOnMondayTo(),
                    'deliveryTimeOnTuesdayFrom' => $orderRequest->getCustomer()->getDeliveryTimeOnTuesdayFrom(),
                    'deliveryTimeOnTuesdayTo' => $orderRequest->getCustomer()->getDeliveryTimeOnTuesdayTo(),
                    'deliveryTimeOnWednesdayFrom' => $orderRequest->getCustomer()->getDeliveryTimeOnWednesdayFrom(),
                    'deliveryTimeOnWednesdayTo' => $orderRequest->getCustomer()->getDeliveryTimeOnWednesdayTo(),
                    'deliveryTimeOnThursdayFrom' => $orderRequest->getCustomer()->getDeliveryTimeOnThursdayFrom(),
                    'deliveryTimeOnThursdayTo' => $orderRequest->getCustomer()->getDeliveryTimeOnThursdayTo(),
                    'deliveryTimeOnFridayFrom' => $orderRequest->getCustomer()->getDeliveryTimeOnFridayFrom(),
                    'deliveryTimeOnFridayTo' => $orderRequest->getCustomer()->getDeliveryTimeOnFridayTo(),
                ],
            ],
        ];
        $response = $this->getClient()->request(
